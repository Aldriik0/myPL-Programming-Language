...
from mypl_translator import Translator
...
def run_translate(in_stream):
    """Executes the given mypl program. Which is then parsed, and semantically
    checked. After that, the AST is then parsed into a Rust file named 'exec.rs'
...
if __name__ == '__main__':
    ...
    help_msg = 'creates a rust file equivalent to the input mypl file'
    group.add_argument('--rust', action='store_true', help=help_msg)    
